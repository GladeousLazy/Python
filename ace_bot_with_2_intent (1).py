...
def build_bot(user_id='navitesh.vaswani@saama.com'):
	...
	l_a_c_master_validate.add_output(l_a_c_account_validate, True)
	l_a_c_master_validate.add_output(l_a_c_actions, False)
	...
	l_a_c_comments_validate.add_output(l_a_c_comments_input, True)
	l_a_c_comments_validate.add_output(l_a_c_actions, False)
